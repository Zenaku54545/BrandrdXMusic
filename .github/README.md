...
- Get your [Necessary Variables](https://github.com/Zenaku54545/BrandrdXMusic/blob/master/sample.env)
---
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/Zenaku54545/BrandrdXMusic && cd BrandrdXMusic
   ```
